...
class PricingApi
{
     ...
     *
     * @param  \Phobetor\Allegro\Model\PublicOfferPreviewRequest $public_offer_preview_request public_offer_preview_request (required)
     *
     * @throws \Phobetor\Allegro\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Phobetor\Allegro\Model\FeePreviewResponse|\Phobetor\Allegro\Model\ErrorsHolder|\Phobetor\Allegro\Model\AuthError|\Phobetor\Allegro\Model\ErrorsHolder
     */
     ...
     * Calculate fee and commission for an offer
     *
     * @param  \Phobetor\Allegro\Model\PublicOfferPreviewRequest $public_offer_preview_request (required)
     *
     * @throws \Phobetor\Allegro\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Phobetor\Allegro\Model\FeePreviewResponse|\Phobetor\Allegro\Model\ErrorsHolder|\Phobetor\Allegro\Model\AuthError|\Phobetor\Allegro\Model\ErrorsHolder, HTTP status code, HTTP response headers (array of strings)
     */
    public function calculateFeePreviewUsingPOSTWithHttpInfo($public_offer_preview_request)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Phobetor\Allegro\Model\FeePreviewResponse' === '\SplFileObject') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Phobetor\Allegro\Model\FeePreviewResponse', []),
            ...
            $returnType = '\Phobetor\Allegro\Model\FeePreviewResponse';
            $responseBody = $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Phobetor\Allegro\Model\FeePreviewResponse',
     ...
     * @throws \Phobetor\Allegro\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Phobetor\Allegro\Model\OfferQuotesDto|\Phobetor\Allegro\Model\ErrorsHolder|\Phobetor\Allegro\Model\ErrorsHolder
     */
     ...
     * @throws \Phobetor\Allegro\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Phobetor\Allegro\Model\OfferQuotesDto|\Phobetor\Allegro\Model\ErrorsHolder|\Phobetor\Allegro\Model\ErrorsHolder, HTTP status code, HTTP response headers (array of strings)
     */
    public function offerQuotesPublicUsingGETWithHttpInfo($offer_id)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Phobetor\Allegro\Model\OfferQuotesDto' === '\SplFileObject') {
                        $content = $responseBody; //stream goes to serializer
                    } else {
                        $content = (string) $responseBody;
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Phobetor\Allegro\Model\OfferQuotesDto', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
            ...
            $returnType = '\Phobetor\Allegro\Model\OfferQuotesDto';
            $responseBody = $response->getBody();
            if ($returnType === '\SplFileObject') {
                $content = $responseBody; //stream goes to serializer
            } else {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Phobetor\Allegro\Model\OfferQuotesDto',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * Preview offer fees
     *
     * @param  \Phobetor\Allegro\Model\WrapperTypeForPreviewConditions $wrapper_type_for_preview_conditions command (required)
     *
     * @throws \Phobetor\Allegro\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Phobetor\Allegro\Model\WrapsListingAndCommissionsFees|\Phobetor\Allegro\Model\ErrorsHolder|\Phobetor\Allegro\Model\ErrorsHolder
     */
     ...
     * @throws \Phobetor\Allegro\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Phobetor\Allegro\Model\WrapsListingAndCommissionsFees|\Phobetor\Allegro\Model\ErrorsHolder|\Phobetor\Allegro\Model\ErrorsHolder, HTTP status code, HTTP response headers (array of strings)
     */
    public function previewFeesPublicAPIUsingPOSTWithHttpInfo($wrapper_type_for_preview_conditions)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Phobetor\Allegro\Model\WrapsListingAndCommissionsFees' === '\SplFileObject') {
                        $content = $responseBody; //stream goes to serializer
                    } else {
                        $content = (string) $responseBody;
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Phobetor\Allegro\Model\WrapsListingAndCommissionsFees', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
            ...
            $returnType = '\Phobetor\Allegro\Model\WrapsListingAndCommissionsFees';
            $responseBody = $response->getBody();
            if ($returnType === '\SplFileObject') {
                $content = $responseBody; //stream goes to serializer
            } else {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Phobetor\Allegro\Model\WrapsListingAndCommissionsFees',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
