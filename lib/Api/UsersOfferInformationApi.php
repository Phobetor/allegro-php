...
/**
     ...
     * @return \Phobetor\Allegro\Model\SellerOfferEventsResponse|\Phobetor\Allegro\Model\ErrorsHolder|\Phobetor\Allegro\Model\AuthError
     */
     ...
     * @throws \Phobetor\Allegro\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Phobetor\Allegro\Model\SellerOfferEventsResponse|\Phobetor\Allegro\Model\ErrorsHolder|\Phobetor\Allegro\Model\AuthError, HTTP status code, HTTP response headers (array of strings)
     */
    public function getOfferEventsWithHttpInfo($from = null, $limit = 100, $type = null, string $contentType = self::contentTypes['getOfferEvents'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Phobetor\Allegro\Model\SellerOfferEventsResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Phobetor\Allegro\Model\SellerOfferEventsResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\Phobetor\Allegro\Model\SellerOfferEventsResponse', []),
            ...
            $returnType = '\Phobetor\Allegro\Model\SellerOfferEventsResponse';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Phobetor\Allegro\Model\SellerOfferEventsResponse',
     ...
     * @throws \Phobetor\Allegro\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Phobetor\Allegro\Model\SmartOfferClassificationReport|\Phobetor\Allegro\Model\GetOfferSmartClassificationGET400Response|\Phobetor\Allegro\Model\AuthError|\Phobetor\Allegro\Model\GetOfferSmartClassificationGET403Response|\Phobetor\Allegro\Model\ErrorsHolder|\Phobetor\Allegro\Model\ErrorsHolder
     */
     ...
     * @throws \Phobetor\Allegro\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Phobetor\Allegro\Model\SmartOfferClassificationReport|\Phobetor\Allegro\Model\GetOfferSmartClassificationGET400Response|\Phobetor\Allegro\Model\AuthError|\Phobetor\Allegro\Model\GetOfferSmartClassificationGET403Response|\Phobetor\Allegro\Model\ErrorsHolder|\Phobetor\Allegro\Model\ErrorsHolder, HTTP status code, HTTP response headers (array of strings)
     */
    public function getOfferSmartClassificationGETWithHttpInfo($offer_id, $marketplace_id = null, string $contentType = self::contentTypes['getOfferSmartClassificationGET'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Phobetor\Allegro\Model\SmartOfferClassificationReport' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Phobetor\Allegro\Model\SmartOfferClassificationReport' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\Phobetor\Allegro\Model\SmartOfferClassificationReport', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
            ...
            $returnType = '\Phobetor\Allegro\Model\SmartOfferClassificationReport';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Phobetor\Allegro\Model\SmartOfferClassificationReport',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    public function searchOffersUsingGETWithHttpInfo($offer_id = null, $name = null, $selling_mode_price_amount_gte = null, $selling_mode_price_amount_lte = null, $selling_mode_price_automation_rule_id = null, $selling_mode_price_automation_rule_id_empty = null, $publication_status = null, $publication_marketplace = null, $selling_mode_format = null, $external_id = null, $delivery_shipping_rates_id = null, $delivery_shipping_rates_id_empty = null, $sort = null, $limit = 20, $offset = null, $category_id = null, $product_id_empty = null, $productization_required = null, $b2b_buyable_only_by_business = null, $fundraising_campaign_id = null, $fundraising_campaign_id_empty = null, string $contentType = self::contentTypes['searchOffersUsingGET'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Phobetor\Allegro\Model\OffersSearchResultDto' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Phobetor\Allegro\Model\OffersSearchResultDto' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\Phobetor\Allegro\Model\OffersSearchResultDto', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Phobetor\Allegro\Model\OffersSearchResultDto',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
