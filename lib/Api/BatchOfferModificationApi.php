...
/**
     ...
     *
     * @param  string $command_id Command identifier. (required)
     * @param  \Phobetor\Allegro\Model\OfferChangeCommand $offer_change_command offerChangeCommandDto (required)
     ...
     *
     * @param  string $command_id Command identifier. (required)
     * @param  \Phobetor\Allegro\Model\OfferPriceChangeCommand $offer_price_change_command offerPriceChangeCommandDto (required)
     ...
     *
     * @param  string $command_id Command identifier. (required)
     * @param  \Phobetor\Allegro\Model\OfferQuantityChangeCommand $offer_quantity_change_command offerQuantityChangeCommandDto (required)
