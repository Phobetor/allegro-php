...
/**
     ...
     * Create variant set
     *
     * @param  \Phobetor\Allegro\Model\VariantSet $variant_set variant_set (required)
     ...
     * @return \Phobetor\Allegro\Model\VariantSetResponse
     */
     ...
     * Create variant set
     *
     * @param  \Phobetor\Allegro\Model\VariantSet $variant_set (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['createVariantSet'] to see the possible values for this operation
     *
     * @throws \Phobetor\Allegro\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Phobetor\Allegro\Model\VariantSetResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function createVariantSetWithHttpInfo($variant_set, string $contentType = self::contentTypes['createVariantSet'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 201:
                    if ('\Phobetor\Allegro\Model\VariantSetResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Phobetor\Allegro\Model\VariantSetResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\Phobetor\Allegro\Model\VariantSetResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\Phobetor\Allegro\Model\VariantSetResponse';
            ...
            switch ($e->getCode()) {
                case 201:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Phobetor\Allegro\Model\VariantSetResponse',
     ...
     * @throws \Phobetor\Allegro\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Phobetor\Allegro\Model\VariantSets
     */
     ...
     * @throws \Phobetor\Allegro\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Phobetor\Allegro\Model\VariantSets, HTTP status code, HTTP response headers (array of strings)
     */
    public function getVariantSetsWithHttpInfo($offset = 0, $limit = 10, $query = null, string $contentType = self::contentTypes['getVariantSets'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Phobetor\Allegro\Model\VariantSets' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Phobetor\Allegro\Model\VariantSets' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\Phobetor\Allegro\Model\VariantSets', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\Phobetor\Allegro\Model\VariantSets';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Phobetor\Allegro\Model\VariantSets',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
