...
/**
            ...
            switch($statusCode) {
                case 200:
                    if ('\Phobetor\Allegro\Model\ChangePrice' === '\SplFileObject') {
                        ...
                        $content = (string) $response->getBody();
                        if ('\Phobetor\Allegro\Model\ChangePrice' !== 'string') {
                            $content = json_decode($content);
                        }
                    }
     ...
     *
     * @param  \Phobetor\Allegro\Model\SaleProductOfferRequestV1 $sale_product_offer_request_v1 sale_product_offer_request_v1 (required)
     ...
     * Create offer based on product
     *
     * @param  \Phobetor\Allegro\Model\SaleProductOfferRequestV1 $sale_product_offer_request_v1 (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['createProductOffers'] to see the possible values for this operation
     *
     * @throws \Phobetor\Allegro\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     ...
     *
     * @param  string $offer_id The offer identifier. (required)
     * @param  \Phobetor\Allegro\Model\SaleProductOfferPatchRequestV1 $sale_product_offer_patch_request_v1 sale_product_offer_patch_request_v1 (required)
     ...
     *
     * @param  string $offer_id The offer identifier. (required)
     * @param  \Phobetor\Allegro\Model\SaleProductOfferPatchRequestV1 $sale_product_offer_patch_request_v1 (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['editProductOffers'] to see the possible values for this operation
     *
     * @throws \Phobetor\Allegro\ApiException on non-2xx response
     * @throws \InvalidArgumentException
            ...
            switch($statusCode) {
                case 200:
                    if ('\Phobetor\Allegro\Model\AvailablePromotionPackages' === '\SplFileObject') {
                        ...
                        $content = (string) $response->getBody();
                        if ('\Phobetor\Allegro\Model\AvailablePromotionPackages' !== 'string') {
                            $content = json_decode($content);
                        }
                    }
            ...
            switch($statusCode) {
                case 200:
                    if ('\Phobetor\Allegro\Model\OfferPromoOptions' === '\SplFileObject') {
                        ...
                        $content = (string) $response->getBody();
                        if ('\Phobetor\Allegro\Model\OfferPromoOptions' !== 'string') {
                            $content = json_decode($content);
                        }
                    }
            ...
            switch($statusCode) {
                case 200:
                    if ('\Phobetor\Allegro\Model\UnfilledParametersResponse' === '\SplFileObject') {
                        ...
                        $content = (string) $response->getBody();
                        if ('\Phobetor\Allegro\Model\UnfilledParametersResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }
            ...
            switch($statusCode) {
                case 202:
                    if ('\Phobetor\Allegro\Model\SaleProductOfferStatusResponse' === '\SplFileObject') {
                        ...
                        $content = (string) $response->getBody();
                        if ('\Phobetor\Allegro\Model\SaleProductOfferStatusResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }
            ...
            switch($statusCode) {
                case 200:
                    if ('\Phobetor\Allegro\Model\PromoModificationReport' === '\SplFileObject') {
                        ...
                        $content = (string) $response->getBody();
                        if ('\Phobetor\Allegro\Model\PromoModificationReport' !== 'string') {
                            $content = json_decode($content);
                        }
                    }
     ...
     * @throws \Phobetor\Allegro\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Phobetor\Allegro\Model\OfferPromoOptionsForSeller|\Phobetor\Allegro\Model\ErrorsHolder|\Phobetor\Allegro\Model\AuthError
     */
     ...
     * @throws \Phobetor\Allegro\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Phobetor\Allegro\Model\OfferPromoOptionsForSeller|\Phobetor\Allegro\Model\ErrorsHolder|\Phobetor\Allegro\Model\AuthError, HTTP status code, HTTP response headers (array of strings)
     */
    public function getPromoOptionsForSellerOffersUsingGETWithHttpInfo($limit = 5000, $offset = 0, string $contentType = self::contentTypes['getPromoOptionsForSellerOffersUsingGET'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Phobetor\Allegro\Model\OfferPromoOptionsForSeller' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Phobetor\Allegro\Model\OfferPromoOptionsForSeller' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\Phobetor\Allegro\Model\OfferPromoOptionsForSeller', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
            ...
            $returnType = '\Phobetor\Allegro\Model\OfferPromoOptionsForSeller';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Phobetor\Allegro\Model\OfferPromoOptionsForSeller',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
