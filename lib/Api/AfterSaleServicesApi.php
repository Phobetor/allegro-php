...
/**
     ...
     *
     * @param  \Phobetor\Allegro\Model\CreateAfterSalesServiceConditionsAttachmentUsingPOSTRequest $create_after_sales_service_conditions_attachment_using_post_request After sale services attachment (required)
            ...
            switch($statusCode) {
                case 201:
                    if ('\Phobetor\Allegro\Model\AfterSalesServicesAttachment' === '\SplFileObject') {
                        ...
                        if ('\Phobetor\Allegro\Model\AfterSalesServicesAttachment' !== 'string') {
            ...
            switch($statusCode) {
                case 201:
                    if ('\Phobetor\Allegro\Model\ImpliedWarrantyResponse' === '\SplFileObject') {
                        ...
                        $content = (string) $response->getBody();
                        if ('\Phobetor\Allegro\Model\ImpliedWarrantyResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }
            ...
            switch($statusCode) {
                case 201:
                    if ('\Phobetor\Allegro\Model\ReturnPolicyResponse' === '\SplFileObject') {
                        ...
                        $content = (string) $response->getBody();
                        if ('\Phobetor\Allegro\Model\ReturnPolicyResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }
            ...
            switch($statusCode) {
                case 201:
                    if ('\Phobetor\Allegro\Model\WarrantyResponse' === '\SplFileObject') {
                        ...
                        $content = (string) $response->getBody();
                        if ('\Phobetor\Allegro\Model\WarrantyResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }
            ...
            switch($statusCode) {
                case 200:
                    if ('\Phobetor\Allegro\Model\ImpliedWarrantiesListImpliedWarrantyBasic' === '\SplFileObject') {
                        ...
                        $content = (string) $response->getBody();
                        if ('\Phobetor\Allegro\Model\ImpliedWarrantiesListImpliedWarrantyBasic' !== 'string') {
                            $content = json_decode($content);
                        }
                    }
            ...
            switch($statusCode) {
                case 200:
                    if ('\Phobetor\Allegro\Model\ReturnPoliciesListReturnPolicyBasic' === '\SplFileObject') {
                        ...
                        $content = (string) $response->getBody();
                        if ('\Phobetor\Allegro\Model\ReturnPoliciesListReturnPolicyBasic' !== 'string') {
                            $content = json_decode($content);
                        }
                    }
            ...
            switch($statusCode) {
                case 200:
                    if ('\Phobetor\Allegro\Model\WarrantiesListWarrantyBasic' === '\SplFileObject') {
                        ...
                        $content = (string) $response->getBody();
                        if ('\Phobetor\Allegro\Model\WarrantiesListWarrantyBasic' !== 'string') {
                            $content = json_decode($content);
                        }
                    }
