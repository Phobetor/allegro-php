...
class AfterSaleServicesApi
{
     ...
     *
     * @param  \Phobetor\Allegro\Model\InlineObject $inline_object inline_object (required)
     *
     * @throws \Phobetor\Allegro\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Phobetor\Allegro\Model\AfterSalesServicesAttachment
     */
     ...
     * Create a warranty attachment metadata
     *
     * @param  \Phobetor\Allegro\Model\InlineObject $inline_object (required)
     *
     * @throws \Phobetor\Allegro\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Phobetor\Allegro\Model\AfterSalesServicesAttachment, HTTP status code, HTTP response headers (array of strings)
     */
    public function createAfterSalesServiceConditionsAttachmentUsingPOSTWithHttpInfo($inline_object)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 201:
                    if ('\Phobetor\Allegro\Model\AfterSalesServicesAttachment' === '\SplFileObject') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Phobetor\Allegro\Model\AfterSalesServicesAttachment', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\Phobetor\Allegro\Model\AfterSalesServicesAttachment';
            $responseBody = $response->getBody();
            ...
            switch ($e->getCode()) {
                case 201:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Phobetor\Allegro\Model\AfterSalesServicesAttachment',
     ...
     *
     * @param  \Phobetor\Allegro\Model\ImpliedWarrantyRequest $implied_warranty_request Implied warranty (required)
     *
     * @throws \Phobetor\Allegro\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Phobetor\Allegro\Model\ImpliedWarrantyResponse
     */
     ...
     * @throws \Phobetor\Allegro\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Phobetor\Allegro\Model\ImpliedWarrantyResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function createAfterSalesServiceImpliedWarrantyUsingPOSTWithHttpInfo($implied_warranty_request)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 201:
                    if ('\Phobetor\Allegro\Model\ImpliedWarrantyResponse' === '\SplFileObject') {
                        $content = $responseBody; //stream goes to serializer
                    } else {
                        $content = (string) $responseBody;
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Phobetor\Allegro\Model\ImpliedWarrantyResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\Phobetor\Allegro\Model\ImpliedWarrantyResponse';
            $responseBody = $response->getBody();
            if ($returnType === '\SplFileObject') {
                $content = $responseBody; //stream goes to serializer
            } else {
            ...
            switch ($e->getCode()) {
                case 201:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Phobetor\Allegro\Model\ImpliedWarrantyResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     *
     * @param  \Phobetor\Allegro\Model\ReturnPolicyRequest $return_policy_request Return Policy (required)
     *
     * @throws \Phobetor\Allegro\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Phobetor\Allegro\Model\ReturnPolicyResponse
     */
     ...
     * @throws \Phobetor\Allegro\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Phobetor\Allegro\Model\ReturnPolicyResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function createAfterSalesServiceReturnPolicyUsingPOSTWithHttpInfo($return_policy_request)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 201:
                    if ('\Phobetor\Allegro\Model\ReturnPolicyResponse' === '\SplFileObject') {
                        $content = $responseBody; //stream goes to serializer
                    } else {
                        $content = (string) $responseBody;
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Phobetor\Allegro\Model\ReturnPolicyResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\Phobetor\Allegro\Model\ReturnPolicyResponse';
            $responseBody = $response->getBody();
            if ($returnType === '\SplFileObject') {
                $content = $responseBody; //stream goes to serializer
            } else {
            ...
            switch ($e->getCode()) {
                case 201:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Phobetor\Allegro\Model\ReturnPolicyResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     *
     * @param  \Phobetor\Allegro\Model\WarrantyRequest $warranty_request Warranty (required)
     *
     * @throws \Phobetor\Allegro\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Phobetor\Allegro\Model\WarrantyResponse
     */
     ...
     * @throws \Phobetor\Allegro\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Phobetor\Allegro\Model\WarrantyResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function createAfterSalesServiceWarrantyUsingPOSTWithHttpInfo($warranty_request)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 201:
                    if ('\Phobetor\Allegro\Model\WarrantyResponse' === '\SplFileObject') {
                        $content = $responseBody; //stream goes to serializer
                    } else {
                        $content = (string) $responseBody;
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Phobetor\Allegro\Model\WarrantyResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\Phobetor\Allegro\Model\WarrantyResponse';
            $responseBody = $response->getBody();
            if ($returnType === '\SplFileObject') {
                $content = $responseBody; //stream goes to serializer
            } else {
            ...
            switch ($e->getCode()) {
                case 201:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Phobetor\Allegro\Model\WarrantyResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    public function getPublicSellerListingUsingGETWithHttpInfo($limit = 60, $offset = 0)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Phobetor\Allegro\Model\ImpliedWarrantiesListImpliedWarrantyBasic' === '\SplFileObject') {
                        $content = $responseBody; //stream goes to serializer
                    } else {
                        $content = (string) $responseBody;
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Phobetor\Allegro\Model\ImpliedWarrantiesListImpliedWarrantyBasic', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Phobetor\Allegro\Model\ImpliedWarrantiesListImpliedWarrantyBasic',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    /**
     * Operation getAfterSalesServiceReturnPoliciesListUsingGET
     *
     ...
     * @throws \Phobetor\Allegro\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Phobetor\Allegro\Model\ReturnPoliciesListReturnPolicyBasic
     */
    public function getAfterSalesServiceReturnPoliciesListUsingGET($limit = 60, $offset = 0)
    {
        list($response) = $this->getAfterSalesServiceReturnPoliciesListUsingGETWithHttpInfo($limit, $offset);
        return $response;
    }

    /**
     * Operation getAfterSalesServiceReturnPoliciesListUsingGETWithHttpInfo
     *
     * Get the user's return policies
     *
     * @param  int $limit The limit of elements in the response. (optional, default to 60)
     ...
     * @throws \Phobetor\Allegro\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Phobetor\Allegro\Model\ReturnPoliciesListReturnPolicyBasic, HTTP status code, HTTP response headers (array of strings)
     */
    public function getAfterSalesServiceReturnPoliciesListUsingGETWithHttpInfo($limit = 60, $offset = 0)
    {
        $request = $this->getAfterSalesServiceReturnPoliciesListUsingGETRequest($limit, $offset);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Phobetor\Allegro\Model\ReturnPoliciesListReturnPolicyBasic' === '\SplFileObject') {
                        $content = $responseBody; //stream goes to serializer
                    } else {
                        $content = (string) $responseBody;
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Phobetor\Allegro\Model\ReturnPoliciesListReturnPolicyBasic', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\Phobetor\Allegro\Model\ReturnPoliciesListReturnPolicyBasic';
            $responseBody = $response->getBody();
            if ($returnType === '\SplFileObject') {
                $content = $responseBody; //stream goes to serializer
            } else {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Phobetor\Allegro\Model\ReturnPoliciesListReturnPolicyBasic',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    /**
     * Operation getAfterSalesServiceReturnPoliciesListUsingGETAsync
     *
     * Get the user's return policies
     *
     * @param  int $limit The limit of elements in the response. (optional, default to 60)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getAfterSalesServiceReturnPoliciesListUsingGETAsync($limit = 60, $offset = 0)
    {
        return $this->getAfterSalesServiceReturnPoliciesListUsingGETAsyncWithHttpInfo($limit, $offset)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getAfterSalesServiceReturnPoliciesListUsingGETAsyncWithHttpInfo
     *
     * Get the user's return policies
     *
     * @param  int $limit The limit of elements in the response. (optional, default to 60)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getAfterSalesServiceReturnPoliciesListUsingGETAsyncWithHttpInfo($limit = 60, $offset = 0)
    {
        $returnType = '\Phobetor\Allegro\Model\ReturnPoliciesListReturnPolicyBasic';
        $request = $this->getAfterSalesServiceReturnPoliciesListUsingGETRequest($limit, $offset);
    ...
    /**
     * Create request for operation 'getAfterSalesServiceReturnPoliciesListUsingGET'
     *
     * @param  int $limit The limit of elements in the response. (optional, default to 60)
     * @param  int $offset The offset of elements in the response. (optional, default to 0)
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getAfterSalesServiceReturnPoliciesListUsingGETRequest($limit = 60, $offset = 0)
    {
        if ($limit !== null && $limit > 60) {
            throw new \InvalidArgumentException('invalid value for "$limit" when calling AfterSaleServicesApi.getAfterSalesServiceReturnPoliciesListUsingGET, must be smaller than or equal to 60.');
        }
        if ($limit !== null && $limit < 1) {
            throw new \InvalidArgumentException('invalid value for "$limit" when calling AfterSaleServicesApi.getAfterSalesServiceReturnPoliciesListUsingGET, must be bigger than or equal to 1.');
        }

        if ($offset !== null && $offset > 59) {
            throw new \InvalidArgumentException('invalid value for "$offset" when calling AfterSaleServicesApi.getAfterSalesServiceReturnPoliciesListUsingGET, must be smaller than or equal to 59.');
        }
        if ($offset !== null && $offset < 0) {
            throw new \InvalidArgumentException('invalid value for "$offset" when calling AfterSaleServicesApi.getAfterSalesServiceReturnPoliciesListUsingGET, must be bigger than or equal to 0.');
        }
    ...
    public function getPublicSellerListingUsingGET2WithHttpInfo($limit = 60, $offset = 0)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Phobetor\Allegro\Model\WarrantiesListWarrantyBasic' === '\SplFileObject') {
                        $content = $responseBody; //stream goes to serializer
                    } else {
                        $content = (string) $responseBody;
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Phobetor\Allegro\Model\WarrantiesListWarrantyBasic', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Phobetor\Allegro\Model\WarrantiesListWarrantyBasic',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
