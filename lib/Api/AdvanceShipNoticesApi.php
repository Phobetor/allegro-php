...
/**
     ...
     *
     * @param  \Phobetor\Allegro\Model\CreateAdvanceShipNoticeRequest $create_advance_ship_notice_request create_advance_ship_notice_request (required)
     ...
     * @return \Phobetor\Allegro\Model\CreateAdvanceShipNoticeResponse|\Phobetor\Allegro\Model\ErrorsHolder|\Phobetor\Allegro\Model\ErrorsHolder
     */
     ...
     * Create an Advance Ship Notice
     *
     * @param  \Phobetor\Allegro\Model\CreateAdvanceShipNoticeRequest $create_advance_ship_notice_request (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['createAdvanceShipNotice'] to see the possible values for this operation
     *
     * @throws \Phobetor\Allegro\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Phobetor\Allegro\Model\CreateAdvanceShipNoticeResponse|\Phobetor\Allegro\Model\ErrorsHolder|\Phobetor\Allegro\Model\ErrorsHolder, HTTP status code, HTTP response headers (array of strings)
     */
    public function createAdvanceShipNoticeWithHttpInfo($create_advance_ship_notice_request, string $contentType = self::contentTypes['createAdvanceShipNotice'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 201:
                    if ('\Phobetor\Allegro\Model\CreateAdvanceShipNoticeResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Phobetor\Allegro\Model\CreateAdvanceShipNoticeResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\Phobetor\Allegro\Model\CreateAdvanceShipNoticeResponse', []),
            ...
            $returnType = '\Phobetor\Allegro\Model\CreateAdvanceShipNoticeResponse';
            ...
            switch ($e->getCode()) {
                case 201:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Phobetor\Allegro\Model\CreateAdvanceShipNoticeResponse',
     ...
     * @throws \Phobetor\Allegro\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Phobetor\Allegro\Model\AdvanceShipNoticeResponse
     */
     ...
     * @throws \Phobetor\Allegro\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Phobetor\Allegro\Model\AdvanceShipNoticeResponse, HTTP status code, HTTP response headers (array of strings)
     */
     ...
     * @throws \Phobetor\Allegro\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Phobetor\Allegro\Model\ReceivingState
     */
     ...
     * @throws \Phobetor\Allegro\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Phobetor\Allegro\Model\ReceivingState, HTTP status code, HTTP response headers (array of strings)
     */
    public function getAdvanceShipNoticeReceivingStateWithHttpInfo($id, string $contentType = self::contentTypes['getAdvanceShipNoticeReceivingState'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Phobetor\Allegro\Model\ReceivingState' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Phobetor\Allegro\Model\ReceivingState' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\Phobetor\Allegro\Model\ReceivingState', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\Phobetor\Allegro\Model\ReceivingState';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Phobetor\Allegro\Model\ReceivingState',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @param  \Phobetor\Allegro\Model\AdvanceShipNoticeStatus[] $status A status of the Advance Ship Notices in the response. (optional)
     ...
     * @throws \Phobetor\Allegro\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Phobetor\Allegro\Model\AdvanceShipNoticeList|\Phobetor\Allegro\Model\ErrorsHolder
     */
     ...
     * @throws \Phobetor\Allegro\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Phobetor\Allegro\Model\AdvanceShipNoticeList|\Phobetor\Allegro\Model\ErrorsHolder, HTTP status code, HTTP response headers (array of strings)
     */
    public function getAdvanceShipNoticesWithHttpInfo($offset = 0, $limit = 50, $status = null, string $contentType = self::contentTypes['getAdvanceShipNotices'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Phobetor\Allegro\Model\AdvanceShipNoticeList' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Phobetor\Allegro\Model\AdvanceShipNoticeList' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\Phobetor\Allegro\Model\AdvanceShipNoticeList', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 422:
            ...
            $returnType = '\Phobetor\Allegro\Model\AdvanceShipNoticeList';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Phobetor\Allegro\Model\AdvanceShipNoticeList',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \Phobetor\Allegro\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Phobetor\Allegro\Model\SubmitCommand|\Phobetor\Allegro\Model\ErrorsHolder
     */
     ...
     * @throws \Phobetor\Allegro\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Phobetor\Allegro\Model\SubmitCommand|\Phobetor\Allegro\Model\ErrorsHolder, HTTP status code, HTTP response headers (array of strings)
     */
    public function getSubmitCommandWithHttpInfo($command_id, string $contentType = self::contentTypes['getSubmitCommand'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Phobetor\Allegro\Model\SubmitCommand' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Phobetor\Allegro\Model\SubmitCommand' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\Phobetor\Allegro\Model\SubmitCommand', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 422:
            ...
            $returnType = '\Phobetor\Allegro\Model\SubmitCommand';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Phobetor\Allegro\Model\SubmitCommand',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     *
     * @param  string $command_id The identifier of the command. (required)
     * @param  \Phobetor\Allegro\Model\SubmitCommand $submit_command submit_command (required)
     ...
     *
     * @param  string $command_id The identifier of the command. (required)
     * @param  \Phobetor\Allegro\Model\SubmitCommand $submit_command (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['submitCommand'] to see the possible values for this operation
     *
     * @throws \Phobetor\Allegro\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     ...
     * @param  \Phobetor\Allegro\Model\AdvanceShipNotice $advance_ship_notice advance_ship_notice (required)
     ...
     * @param  string $id An identifier of Advance Ship Notice. (required)
     * @param  string $if_match A current version of Advance Ship Notice (e.g. from etag header obtained via get). (required)
     * @param  \Phobetor\Allegro\Model\AdvanceShipNotice $advance_ship_notice (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['updateAdvanceShipNotice'] to see the possible values for this operation
     *
     * @throws \Phobetor\Allegro\ApiException on non-2xx response
     * @throws \InvalidArgumentException
