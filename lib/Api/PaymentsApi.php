...
/**
     ...
     * @return |\Phobetor\Allegro\Model\PaymentOperations|\Phobetor\Allegro\Model\ErrorsHolder
     */
     ...
     * @throws \Phobetor\Allegro\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of |\Phobetor\Allegro\Model\PaymentOperations|\Phobetor\Allegro\Model\ErrorsHolder, HTTP status code, HTTP response headers (array of strings)
     */
    public function getPaymentsOperationHistoryWithHttpInfo($wallet_type = 'AVAILABLE', $wallet_payment_operator = null, $payment_id = null, $participant_login = null, $occurred_at_gte = null, $occurred_at_lte = null, $group = null, $marketplace_id = null, $currency = null, $limit = 50, $offset = 0, string $contentType = self::contentTypes['getPaymentsOperationHistory'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Phobetor\Allegro\Model\PaymentOperations' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Phobetor\Allegro\Model\PaymentOperations' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\Phobetor\Allegro\Model\PaymentOperations', []),
            ...
            $returnType = '\Phobetor\Allegro\Model\PaymentOperations';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Phobetor\Allegro\Model\PaymentOperations',
     ...
     * @throws \Phobetor\Allegro\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Phobetor\Allegro\Model\GetRefundedPayments200Response|\Phobetor\Allegro\Model\AuthError|\Phobetor\Allegro\Model\GetOfferSmartClassificationGET403Response|\Phobetor\Allegro\Model\ErrorsHolder
     */
     ...
     * @throws \Phobetor\Allegro\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Phobetor\Allegro\Model\GetRefundedPayments200Response|\Phobetor\Allegro\Model\AuthError|\Phobetor\Allegro\Model\GetOfferSmartClassificationGET403Response|\Phobetor\Allegro\Model\ErrorsHolder, HTTP status code, HTTP response headers (array of strings)
     */
    public function getRefundedPaymentsWithHttpInfo($limit = 50, $offset = 0, $id = null, $payment_id = null, $occurred_at_gte = null, $occurred_at_lte = null, $status = null, string $contentType = self::contentTypes['getRefundedPayments'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Phobetor\Allegro\Model\GetRefundedPayments200Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Phobetor\Allegro\Model\GetRefundedPayments200Response' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\Phobetor\Allegro\Model\GetRefundedPayments200Response', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 401:
            ...
            $returnType = '\Phobetor\Allegro\Model\GetRefundedPayments200Response';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Phobetor\Allegro\Model\GetRefundedPayments200Response',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     *
     * @param  \Phobetor\Allegro\Model\InitializeRefund $initialize_refund initialize_refund (optional)
     ...
     * @throws \Phobetor\Allegro\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Phobetor\Allegro\Model\RefundDetails|\Phobetor\Allegro\Model\ErrorsHolder|\Phobetor\Allegro\Model\AuthError|\Phobetor\Allegro\Model\ErrorsHolder|\Phobetor\Allegro\Model\GetOfferSmartClassificationGET403Response|\Phobetor\Allegro\Model\ErrorsHolder
     */
     ...
     * Initiate a refund of a payment
     *
     * @param  \Phobetor\Allegro\Model\InitializeRefund $initialize_refund (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['initiateRefund'] to see the possible values for this operation
     *
     * @throws \Phobetor\Allegro\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Phobetor\Allegro\Model\RefundDetails|\Phobetor\Allegro\Model\ErrorsHolder|\Phobetor\Allegro\Model\AuthError|\Phobetor\Allegro\Model\ErrorsHolder|\Phobetor\Allegro\Model\GetOfferSmartClassificationGET403Response|\Phobetor\Allegro\Model\ErrorsHolder, HTTP status code, HTTP response headers (array of strings)
     */
    public function initiateRefundWithHttpInfo($initialize_refund = null, string $contentType = self::contentTypes['initiateRefund'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Phobetor\Allegro\Model\RefundDetails' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Phobetor\Allegro\Model\RefundDetails' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\Phobetor\Allegro\Model\RefundDetails', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
            ...
            $returnType = '\Phobetor\Allegro\Model\RefundDetails';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Phobetor\Allegro\Model\RefundDetails',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
