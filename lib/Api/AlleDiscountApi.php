...
/**
     ...
     * @return \Phobetor\Allegro\Model\AlleDiscountListCampaignsResponse|\Phobetor\Allegro\Model\ErrorsHolder|\Phobetor\Allegro\Model\ErrorsHolder
     */
     ...
     * @throws \Phobetor\Allegro\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Phobetor\Allegro\Model\AlleDiscountListCampaignsResponse|\Phobetor\Allegro\Model\ErrorsHolder|\Phobetor\Allegro\Model\ErrorsHolder, HTTP status code, HTTP response headers (array of strings)
     */
    public function getAlleDiscountCampaignsWithHttpInfo($campaign_id = null, string $contentType = self::contentTypes['getAlleDiscountCampaigns'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Phobetor\Allegro\Model\AlleDiscountListCampaignsResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Phobetor\Allegro\Model\AlleDiscountListCampaignsResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\Phobetor\Allegro\Model\AlleDiscountListCampaignsResponse', []),
            ...
            $returnType = '\Phobetor\Allegro\Model\AlleDiscountListCampaignsResponse';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Phobetor\Allegro\Model\AlleDiscountListCampaignsResponse',
     ...
     * @throws \Phobetor\Allegro\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Phobetor\Allegro\Model\AlleDiscountListEligibleResponse|\Phobetor\Allegro\Model\ErrorsHolder
     */
     ...
     * @throws \Phobetor\Allegro\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Phobetor\Allegro\Model\AlleDiscountListEligibleResponse|\Phobetor\Allegro\Model\ErrorsHolder, HTTP status code, HTTP response headers (array of strings)
     */
    public function getOffersEligibleForAlleDiscountWithHttpInfo($campaign_id, $limit = null, $offset = null, $meets_conditions = null, $offer_id = null, string $contentType = self::contentTypes['getOffersEligibleForAlleDiscount'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Phobetor\Allegro\Model\AlleDiscountListEligibleResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Phobetor\Allegro\Model\AlleDiscountListEligibleResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\Phobetor\Allegro\Model\AlleDiscountListEligibleResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
            ...
            $returnType = '\Phobetor\Allegro\Model\AlleDiscountListEligibleResponse';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Phobetor\Allegro\Model\AlleDiscountListEligibleResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \Phobetor\Allegro\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Phobetor\Allegro\Model\AlleDiscountListSubmittedResponse|\Phobetor\Allegro\Model\ErrorsHolder
     */
     ...
     * @throws \Phobetor\Allegro\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Phobetor\Allegro\Model\AlleDiscountListSubmittedResponse|\Phobetor\Allegro\Model\ErrorsHolder, HTTP status code, HTTP response headers (array of strings)
     */
    public function getOffersSubmittedToAlleDiscountWithHttpInfo($campaign_id, $limit = null, $offset = null, $offer_id = null, $participation_id = null, string $contentType = self::contentTypes['getOffersSubmittedToAlleDiscount'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Phobetor\Allegro\Model\AlleDiscountListSubmittedResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Phobetor\Allegro\Model\AlleDiscountListSubmittedResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\Phobetor\Allegro\Model\AlleDiscountListSubmittedResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
            ...
            $returnType = '\Phobetor\Allegro\Model\AlleDiscountListSubmittedResponse';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Phobetor\Allegro\Model\AlleDiscountListSubmittedResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \Phobetor\Allegro\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Phobetor\Allegro\Model\AlleDiscountGetSubmitCommandResponse
     */
     ...
     * @throws \Phobetor\Allegro\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Phobetor\Allegro\Model\AlleDiscountGetSubmitCommandResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function getSubmitOfferToAlleDiscountCommandsStatusWithHttpInfo($command_id, string $contentType = self::contentTypes['getSubmitOfferToAlleDiscountCommandsStatus'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Phobetor\Allegro\Model\AlleDiscountGetSubmitCommandResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Phobetor\Allegro\Model\AlleDiscountGetSubmitCommandResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\Phobetor\Allegro\Model\AlleDiscountGetSubmitCommandResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\Phobetor\Allegro\Model\AlleDiscountGetSubmitCommandResponse';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Phobetor\Allegro\Model\AlleDiscountGetSubmitCommandResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \Phobetor\Allegro\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Phobetor\Allegro\Model\AlleDiscountGetWithdrawCommandResponse
     */
     ...
     * @throws \Phobetor\Allegro\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Phobetor\Allegro\Model\AlleDiscountGetWithdrawCommandResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function getWithdrawOfferFromAlleDiscountCommandsStatusWithHttpInfo($command_id, string $contentType = self::contentTypes['getWithdrawOfferFromAlleDiscountCommandsStatus'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Phobetor\Allegro\Model\AlleDiscountGetWithdrawCommandResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Phobetor\Allegro\Model\AlleDiscountGetWithdrawCommandResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\Phobetor\Allegro\Model\AlleDiscountGetWithdrawCommandResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\Phobetor\Allegro\Model\AlleDiscountGetWithdrawCommandResponse';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Phobetor\Allegro\Model\AlleDiscountGetWithdrawCommandResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     *
     * @param  \Phobetor\Allegro\Model\AlleDiscountSubmitCommandRequest $alle_discount_submit_command_request alle_discount_submit_command_request (required)
     ...
     * @throws \Phobetor\Allegro\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Phobetor\Allegro\Model\AlleDiscountSubmitCommandResponse|\Phobetor\Allegro\Model\ErrorsHolder
     */
     ...
     * Create submit offer command
     *
     * @param  \Phobetor\Allegro\Model\AlleDiscountSubmitCommandRequest $alle_discount_submit_command_request (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['submitOfferToAlleDiscountCommands'] to see the possible values for this operation
     *
     * @throws \Phobetor\Allegro\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Phobetor\Allegro\Model\AlleDiscountSubmitCommandResponse|\Phobetor\Allegro\Model\ErrorsHolder, HTTP status code, HTTP response headers (array of strings)
     */
    public function submitOfferToAlleDiscountCommandsWithHttpInfo($alle_discount_submit_command_request, string $contentType = self::contentTypes['submitOfferToAlleDiscountCommands'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 201:
                    if ('\Phobetor\Allegro\Model\AlleDiscountSubmitCommandResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Phobetor\Allegro\Model\AlleDiscountSubmitCommandResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\Phobetor\Allegro\Model\AlleDiscountSubmitCommandResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
            ...
            $returnType = '\Phobetor\Allegro\Model\AlleDiscountSubmitCommandResponse';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 201:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Phobetor\Allegro\Model\AlleDiscountSubmitCommandResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     *
     * @param  \Phobetor\Allegro\Model\AlleDiscountWithdrawCommandRequest $alle_discount_withdraw_command_request alle_discount_withdraw_command_request (required)
     ...
     * @throws \Phobetor\Allegro\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Phobetor\Allegro\Model\AlleDiscountWithdrawCommandResponse|\Phobetor\Allegro\Model\ErrorsHolder
     */
     ...
     * Create withdraw offer command
     *
     * @param  \Phobetor\Allegro\Model\AlleDiscountWithdrawCommandRequest $alle_discount_withdraw_command_request (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['withdrawOfferFromAlleDiscountCommands'] to see the possible values for this operation
     *
     * @throws \Phobetor\Allegro\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Phobetor\Allegro\Model\AlleDiscountWithdrawCommandResponse|\Phobetor\Allegro\Model\ErrorsHolder, HTTP status code, HTTP response headers (array of strings)
     */
    public function withdrawOfferFromAlleDiscountCommandsWithHttpInfo($alle_discount_withdraw_command_request, string $contentType = self::contentTypes['withdrawOfferFromAlleDiscountCommands'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 201:
                    if ('\Phobetor\Allegro\Model\AlleDiscountWithdrawCommandResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Phobetor\Allegro\Model\AlleDiscountWithdrawCommandResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\Phobetor\Allegro\Model\AlleDiscountWithdrawCommandResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
            ...
            $returnType = '\Phobetor\Allegro\Model\AlleDiscountWithdrawCommandResponse';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 201:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Phobetor\Allegro\Model\AlleDiscountWithdrawCommandResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
