...
/**
    ...
    public function getCustomerReturnByIdWithHttpInfo($customer_return_id, string $contentType = self::contentTypes['getCustomerReturnById'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Phobetor\Allegro\Model\CustomerReturn' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Phobetor\Allegro\Model\CustomerReturn' !== 'string') {
            ...
            $returnType = '\Phobetor\Allegro\Model\CustomerReturn';
    ...
    public function getCustomerReturnsWithHttpInfo($customer_return_id = null, $order_id = null, $items_offer_id = null, $items_name = null, $parcels_waybill = null, $parcels_carrier_id = null, $parcels_sender_phone_number = null, $reference_number = null, $from = null, $created_at_gte = null, $created_at_lte = null, $marketplace_id = null, $limit = 100, $offset = 0, string $contentType = self::contentTypes['getCustomerReturns'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Phobetor\Allegro\Model\CustomerReturnResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Phobetor\Allegro\Model\CustomerReturnResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Phobetor\Allegro\Model\CustomerReturnResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     *
     * @param  string $customer_return_id Id of the customer return. (required)
     * @param  \Phobetor\Allegro\Model\CustomerReturnRefundRejectionRequest $customer_return_refund_rejection_request customer_return_refund_rejection_request (required)
     ...
     *
     * @param  string $customer_return_id Id of the customer return. (required)
     * @param  \Phobetor\Allegro\Model\CustomerReturnRefundRejectionRequest $customer_return_refund_rejection_request (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['rejectCustomerReturnRefund'] to see the possible values for this operation
     *
     * @throws \Phobetor\Allegro\ApiException on non-2xx response
     * @throws \InvalidArgumentException
