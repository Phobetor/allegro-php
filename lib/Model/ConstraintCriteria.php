...
class ConstraintCriteria implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'country' => 'string',
        'type' => 'string',
        'delivery_methods' => '\Phobetor\Allegro\Model\JustId[]'
    ];
    ...
    */
     ...
     *
     * @param \Phobetor\Allegro\Model\JustId[]|null $delivery_methods This is used by additional services that are realised in transport (e.g. CARRY_IN), and this field exists together with COUNTRY_DELIVERY_SAME_QUANTITY constraint type. It describes which delivery methods can realise particular service.
     *
     * @return self
     */
