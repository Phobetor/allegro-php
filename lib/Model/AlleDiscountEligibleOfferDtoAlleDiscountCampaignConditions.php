 ...
 */
class AlleDiscountEligibleOfferDtoAlleDiscountCampaignConditions implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AlleDiscountEligibleOfferDto_alleDiscount_campaignConditions';
    ...
    {
        $this->setIfExists('meets_conditions', $data ?? [], null);
    ...
    */
     ...
     *
     * @param bool|null $meets_conditions If true, offer matches campaign requirements and `violations` array will be empty.
     *
     * @return self
     */
    public function setMeetsConditions($meets_conditions)
    {
        if (is_null($meets_conditions)) {
            throw new \InvalidArgumentException('non-nullable meets_conditions cannot be null');
        }
     ...
     * Gets violations
     *
     * @return \Phobetor\Allegro\Model\AlleDiscountEligibleOfferDtoAlleDiscountCampaignConditionsViolationsInner[]|null
     */
