...
class BadgeOperationProcess implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     *
     * @param \Phobetor\Allegro\Model\BadgeApplicationRejectionReason[] $rejection_reasons A list of rejection reasons for the badge operation. Returned for process.status = DECLINED only.
     *
     * @return self
     */
