...
class SmartOfferClassificationReportConditionsInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'description' => 'string',
        'fulfilled' => 'bool',
        'passed_delivery_methods' => '\Phobetor\Allegro\Model\DeliveryMethodId[]',
        'failed_delivery_methods' => '\Phobetor\Allegro\Model\DeliveryMethodId[]'
    ];
    ...
    */
     ...
     *
     * @return \Phobetor\Allegro\Model\DeliveryMethodId[]|null
     */
     ...
     *
     * @param \Phobetor\Allegro\Model\DeliveryMethodId[]|null $passed_delivery_methods Set of delivery methods that meet this condition. May be null if the condition does not apply to delivery methods.
     *
     * @return self
     */
     ...
     *
     * @param \Phobetor\Allegro\Model\DeliveryMethodId[]|null $failed_delivery_methods Set of delivery methods that fail to meet this condition. May be null if the condition does not apply to delivery methods.
     *
     * @return self
     */
