...
/**
 * ResponsibleProducerContact Class Doc Comment
 *
 * @category Class
 * @description Contact to responsible producer.
 * @package  Phobetor\Allegro
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class ResponsibleProducerContact implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ResponsibleProducerContact';
    ...
    */
     ...
     * Sets email
     *
     * @param string|null $email Email of responsible producer.
     *
     * @return self
     */
    public function setEmail($email)
    {
        ...
        if ((mb_strlen($email) > 50)) {
            throw new \InvalidArgumentException('invalid length for $email when calling ResponsibleProducerContact., must be smaller than or equal to 50.');
        }
     ...
     * Sets phone_number
     *
     * @param string|null $phone_number Phone number of responsible producer. This field is optional.
     *
     * @return self
     */
    public function setPhoneNumber($phone_number)
    {
        ...
        if ((mb_strlen($phone_number) > 30)) {
            throw new \InvalidArgumentException('invalid length for $phone_number when calling ResponsibleProducerContact., must be smaller than or equal to 30.');
        }
