...
class CheckoutFormInvoiceAddressCompany implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'name' => 'string',
        'ids' => '\Phobetor\Allegro\Model\CheckoutFormInvoiceAddressCompanyId[]',
    ...
    */
     ...
     * Gets ids
     *
     * @return \Phobetor\Allegro\Model\CheckoutFormInvoiceAddressCompanyId[]|null
     */
     ...
     * Sets ids
     *
     * @param \Phobetor\Allegro\Model\CheckoutFormInvoiceAddressCompanyId[]|null $ids Tax ids of a company for which invoice should be issued.
     *
     * @return self
     */
