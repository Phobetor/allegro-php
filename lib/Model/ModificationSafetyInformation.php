...
/**
 * ModificationSafetyInformation Class Doc Comment
 *
 * @category Class
 ...
 */
class ModificationSafetyInformation implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ModificationSafetyInformation';
    ...
    */
     ...
     * Sets type
     *
     * @param string $type _Note: if the offer contains multiple products, the safety information will only be changed for the first product._
     *
     * @return self
     */
