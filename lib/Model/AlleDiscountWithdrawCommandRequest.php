 ...
 */
class AlleDiscountWithdrawCommandRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AlleDiscountWithdrawCommandRequest';
    ...
    protected static $openAPITypes = [
        'command_id' => 'string',
        'input' => '\Phobetor\Allegro\Model\AlleDiscountWithdrawCommandRequestInput'
    ];
    ...
    */
     ...
     * Sets command_id
     *
     * @param string|null $command_id The Command UUID. If empty, system generates new one.
     *
     * @return self
     */
    public function setCommandId($command_id)
    {
        if (is_null($command_id)) {
            array_push($this->openAPINullablesSetToNull, 'command_id');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('command_id', $nullablesSetToNull);
            if ($index !== FALSE) {
     ...
     * Gets input
     *
     * @return \Phobetor\Allegro\Model\AlleDiscountWithdrawCommandRequestInput|null
     */
     ...
     * Sets input
     *
     * @param \Phobetor\Allegro\Model\AlleDiscountWithdrawCommandRequestInput|null $input input
     *
     * @return self
     */
