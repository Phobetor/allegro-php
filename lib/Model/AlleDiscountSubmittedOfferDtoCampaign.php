 ...
 */
class AlleDiscountSubmittedOfferDtoCampaign implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AlleDiscountSubmittedOfferDto_campaign';
