...
class CheckoutFormAddWaybillRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Gets line_items
     *
     * @return \Phobetor\Allegro\Model\CheckoutFormAddWaybillRequestLineItemsInner[]|null
     */
     ...
     * Sets line_items
     *
     * @param \Phobetor\Allegro\Model\CheckoutFormAddWaybillRequestLineItemsInner[]|null $line_items List of order line items. They must be from the order specified in the path parameter. When list is not provided or it is empty it means that every item from an order is included in shipment.
     *
     * @return self
     */
