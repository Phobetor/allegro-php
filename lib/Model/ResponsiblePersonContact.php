    ...
    */
    ...
    public function setEmail($email)
    {
        ...
        if ((mb_strlen($email) > 50)) {
            throw new \InvalidArgumentException('invalid length for $email when calling ResponsiblePersonContact., must be smaller than or equal to 50.');
        }
     ...
     * Sets phone_number
     *
     * @param string|null $phone_number Phone number of responsible person. This field is optional.
     *
     * @return self
     */
    public function setPhoneNumber($phone_number)
    {
        ...
        if ((mb_strlen($phone_number) > 30)) {
            throw new \InvalidArgumentException('invalid length for $phone_number when calling ResponsiblePersonContact., must be smaller than or equal to 30.');
        }
