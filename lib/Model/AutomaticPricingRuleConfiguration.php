 ...
 */
class AutomaticPricingRuleConfiguration implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AutomaticPricingRuleConfiguration';
    ...
    protected static $openAPITypes = [
        'change_by_percentage' => '\Phobetor\Allegro\Model\AutomaticPricingRuleConfigurationChangeByPercentage'
    ];
    ...
    {
        $this->setIfExists('change_by_percentage', $data ?? [], null);
    }
    ...
    */
     ...
     *
     * @return \Phobetor\Allegro\Model\AutomaticPricingRuleConfigurationChangeByPercentage|null
     */
     ...
     *
     * @param \Phobetor\Allegro\Model\AutomaticPricingRuleConfigurationChangeByPercentage|null $change_by_percentage change_by_percentage
     *
     * @return self
     */
    public function setChangeByPercentage($change_by_percentage)
    {
        if (is_null($change_by_percentage)) {
            throw new \InvalidArgumentException('non-nullable change_by_percentage cannot be null');
        }
