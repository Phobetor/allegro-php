 ...
 */
class AlleDiscountGetSubmitCommandResponseOutputNewOfferParticipation implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AlleDiscountGetSubmitCommandResponse_output_newOfferParticipation';
    ...
    */
     ...
     *
     * @param string|null $participation_id The id of the participation created by submit offer command.
     *
     * @return self
     */
