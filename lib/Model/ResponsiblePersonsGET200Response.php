...
class ResponsiblePersonsGET200Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'responsible_persons' => '\Phobetor\Allegro\Model\ResponsiblePersonResponse[]',
        'count' => 'int',
        'total_count' => 'int'
    ];
    ...
    */
     ...
     *
     * @return \Phobetor\Allegro\Model\ResponsiblePersonResponse[]|null
     */
     ...
     *
     * @param \Phobetor\Allegro\Model\ResponsiblePersonResponse[]|null $responsible_persons responsible_persons
     *
     * @return self
     */
     ...
     * Sets count
     *
     * @param int|null $count Number of responsible persons data returned in search result for the given parameters.
     *
     * @return self
     */
    public function setCount($count)
    {
        ...
        if (($count < 0)) {
            throw new \InvalidArgumentException('invalid value for $count when calling ResponsiblePersonsGET200Response., must be bigger than or equal to 0.');
        }
     ...
     * Sets total_count
     *
     * @param int|null $total_count Total number of available responsible persons data.
     *
     * @return self
     */
    public function setTotalCount($total_count)
    {
        ...
        if (($total_count < 0)) {
            throw new \InvalidArgumentException('invalid value for $total_count when calling ResponsiblePersonsGET200Response., must be bigger than or equal to 0.');
        }
