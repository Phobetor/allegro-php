 ...
 */
class AlleDiscountWithdrawCommandRequestInput implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AlleDiscountWithdrawCommandRequest_input';
    ...
    */
     ...
     *
     * @param string|null $participation_id The id of the offer participation you wish to withdraw. Participation id can be found using `GET /sale/alle-discount/{campaignId}/submitted-offers` or `GET /sale/alle-discount/submit-offer-commands` endpoints.
     *
     * @return self
     */
