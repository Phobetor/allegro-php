...
class OfferShippingRates implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'rates' => '\Phobetor\Allegro\Model\ShippingRate[]'
    ];
    ...
    */
     ...
     * Gets rates
     *
     * @return \Phobetor\Allegro\Model\ShippingRate[]|null
     */
     ...
     * Sets rates
     *
     * @param \Phobetor\Allegro\Model\ShippingRate[]|null $rates If empty there is the shipping rates set attached to offer. You should use the GET /sale/offers/{offerId} resource to retrieve the shipping rates set ID.
     *
     * @return self
     */
