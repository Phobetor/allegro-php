...
class Courier implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets id
     *
     * @param string|null $id Supported courier ids are ALLEGRO, DB_SCHENKER, DHL, DPD, DPD_SK, INPOST, ORLEN, POCZTA_POLSKA, SUUS, UPS. If requested courier is not supported then use OTHER value and provide courier name in name field.
     *
     * @return self
     */
     ...
     * Sets name
     *
     * @param string|null $name Courier name to be provided only if id is OTHER, otherwise it's ignored.
     *
     * @return self
     */
     ...
     *
     * @param string[]|null $tracking_numbers List of tracking numbers.
     *
     * @return self
     */
