...
class BadgeApplicationProcess implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'status' => 'string',
        'rejection_reasons' => '\Phobetor\Allegro\Model\BadgeApplicationRejectionReason[]'
    ];
    ...
    */
     ...
     *
     * @return \Phobetor\Allegro\Model\BadgeApplicationRejectionReason[]
     */
     ...
     *
     * @param \Phobetor\Allegro\Model\BadgeApplicationRejectionReason[] $rejection_reasons A list of rejection reasons for the badge application. Returned for process.status = DECLINED only.
     *
     * @return self
     */
