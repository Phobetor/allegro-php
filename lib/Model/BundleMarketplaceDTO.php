...
/**
 * BundleMarketplaceDTO Class Doc Comment
 *
 * @category Class
 * @package  Phobetor\Allegro
 * @author   OpenAPI Generator team
 ...
 */
class BundleMarketplaceDTO implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'BundleMarketplaceDTO';
    ...
    */
     ...
     * Sets id
     *
     * @param string $id Marketplace ID. Available marketplaces can be determined using <a href=\"#operation/marketplacesGET\">GET /marketplaces</a>.
     *
     * @return self
     */
