...
class AllegroPricesOfferConsentChangeResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     *
     * @param array<string,\Phobetor\Allegro\Model\AllegroPricesAccountChangeRequestAdditionalMarketplacesValue>|null $additional_marketplaces Consent statuses on marketplaces other than the base marketplace of the offer.
     *
     * @return self
     */
