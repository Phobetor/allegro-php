 ...
 */
class AlleDiscountGetWithdrawCommandResponseOutput implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AlleDiscountGetWithdrawCommandResponse_output';
    ...
    protected static $openAPITypes = [
        ...
        'created_at' => '\DateTime',
        'updated_at' => '\DateTime',
        'withdrawn_offer_participation' => '\Phobetor\Allegro\Model\AlleDiscountGetWithdrawCommandResponseOutputWithdrawnOfferParticipation',
        'errors' => '\Phobetor\Allegro\Model\ErrorsHolder[]'
    ];
    ...
    protected static array $openAPINullables = [
		...
		'created_at' => false,
		'updated_at' => false,
		'withdrawn_offer_participation' => true,
		'errors' => false
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('withdrawn_offer_participation', $data ?? [], null);
    ...
    */
     ...
     * Sets created_at
     *
     * @param \DateTime|null $created_at Command creation date. ISO 8601 format.
     *
     * @return self
     */
     ...
     * Sets updated_at
     *
     * @param \DateTime|null $updated_at Command update date. ISO 8601 format.
     *
     * @return self
     */
     ...
     *
     * @return \Phobetor\Allegro\Model\AlleDiscountGetWithdrawCommandResponseOutputWithdrawnOfferParticipation|null
     */
     ...
     *
     * @param \Phobetor\Allegro\Model\AlleDiscountGetWithdrawCommandResponseOutputWithdrawnOfferParticipation|null $withdrawn_offer_participation withdrawn_offer_participation
     *
     * @return self
     */
    public function setWithdrawnOfferParticipation($withdrawn_offer_participation)
    {
        if (is_null($withdrawn_offer_participation)) {
            array_push($this->openAPINullablesSetToNull, 'withdrawn_offer_participation');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('withdrawn_offer_participation', $nullablesSetToNull);
            if ($index !== FALSE) {
     ...
     * Gets errors
     *
     * @return \Phobetor\Allegro\Model\ErrorsHolder[]|null
     */
     ...
     * Sets errors
     *
     * @param \Phobetor\Allegro\Model\ErrorsHolder[]|null $errors errors
     *
     * @return self
     */
