...
class ResponsiblePersonResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'id' => 'string',
        'name' => 'string',
        'personal_data' => '\Phobetor\Allegro\Model\ResponsiblePersonResponsePersonalData'
    ];
    ...
    */
     ...
     * Sets name
     *
     * @param string|null $name Internal name of responsible person in dictionary (visible only to you).
     *
     * @return self
     */
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) > 50)) {
            throw new \InvalidArgumentException('invalid length for $name when calling ResponsiblePersonResponse., must be smaller than or equal to 50.');
        }
     ...
     * Gets personal_data
     *
     * @return \Phobetor\Allegro\Model\ResponsiblePersonResponsePersonalData|null
     */
     ...
     * Sets personal_data
     *
     * @param \Phobetor\Allegro\Model\ResponsiblePersonResponsePersonalData|null $personal_data personal_data
     *
     * @return self
     */
