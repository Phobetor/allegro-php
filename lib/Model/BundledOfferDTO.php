...
/**
 * BundledOfferDTO Class Doc Comment
 *
 * @category Class
 * @package  Phobetor\Allegro
 * @author   OpenAPI Generator team
 ...
 */
class BundledOfferDTO implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'BundledOfferDTO';
    ...
    */
     ...
     *
     * @param int $required_quantity How many units of this offer will be in bundle.
     *
     * @return self
     */
     ...
     * Sets entry_point
     *
     * @param bool $entry_point Set if bundle should be shown on offer page.
     *
     * @return self
     */
