...
class SaleProductOfferPublicationMarketplacesRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets additional
     *
     * @param \Phobetor\Allegro\Model\JustId[]|null $additional Specifies whether an offer should be visible in the additional marketplace. This field is not mandatory. We will interpret the absence of this field as an empty array (the listing will be visible only in its base marketplace).
     *
     * @return self
     */
