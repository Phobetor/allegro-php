...
```php
createTableUsingPOST($size_table_post_request): \Phobetor\Allegro\Model\PublicTableDto
```
...
$size_table_post_request = new \Phobetor\Allegro\Model\SizeTablePostRequest(); // \Phobetor\Allegro\Model\SizeTablePostRequest | Size table details
...
| ------------- | ------------- | ------------- | ------------- |
| **size_table_post_request** | [**\Phobetor\Allegro\Model\SizeTablePostRequest**](../Model/SizeTablePostRequest.md)| Size table details | |
...
```php
getTablesTemplatesUsingGET(): \Phobetor\Allegro\Model\SizeTableTemplatesResponse
```
...
[**\Phobetor\Allegro\Model\SizeTableTemplatesResponse**](../Model/SizeTableTemplatesResponse.md)
...
```php
modifyTableUsingPUT($table_id, $size_table_put_request): \Phobetor\Allegro\Model\PublicTableDto
```
...
$table_id = 'table_id_example'; // string | Table identifier.
$size_table_put_request = new \Phobetor\Allegro\Model\SizeTablePutRequest(); // \Phobetor\Allegro\Model\SizeTablePutRequest | Size table details
...
| ------------- | ------------- | ------------- | ------------- |
| **table_id** | **string**| Table identifier. | |
| **size_table_put_request** | [**\Phobetor\Allegro\Model\SizeTablePutRequest**](../Model/SizeTablePutRequest.md)| Size table details | |
