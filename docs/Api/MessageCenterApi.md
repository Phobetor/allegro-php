# Phobetor\Allegro\MessageCenterApi
...
```php
changeReadFlagOnThreadPUT($thread_id, $thread_read_flag): \Phobetor\Allegro\Model\Thread
```
...
$apiInstance = new Phobetor\Allegro\Api\MessageCenterApi(
...
$thread_read_flag = new \Phobetor\Allegro\Model\ThreadReadFlag(); // \Phobetor\Allegro\Model\ThreadReadFlag | Updated read flag
...
| **thread_read_flag** | [**\Phobetor\Allegro\Model\ThreadReadFlag**](../Model/ThreadReadFlag.md)| Updated read flag | |

### Return type

[**\Phobetor\Allegro\Model\Thread**](../Model/Thread.md)
...
```php
getMessageGET($message_id): \Phobetor\Allegro\Model\Message
```
...
[**\Phobetor\Allegro\Model\Message**](../Model/Message.md)
...
```php
getThreadGET($thread_id): \Phobetor\Allegro\Model\Thread
```
...
```php
listMessagesGET($thread_id, $limit, $offset, $before, $after): \Phobetor\Allegro\Model\MessagesList
```
...
[**\Phobetor\Allegro\Model\MessagesList**](../Model/MessagesList.md)
...
```php
listThreadsGET($limit, $offset): \Phobetor\Allegro\Model\ThreadsList
```
...
[**\Phobetor\Allegro\Model\ThreadsList**](../Model/ThreadsList.md)
...
```php
newAttachmentDeclarationPOST($new_attachment_declaration): \Phobetor\Allegro\Model\MessageAttachmentId
```
...
$new_attachment_declaration = new \Phobetor\Allegro\Model\NewAttachmentDeclaration(); // \Phobetor\Allegro\Model\NewAttachmentDeclaration
...
| Name | Type | Description  | Notes |
| ------------- | ------------- | ------------- | ------------- |
| **new_attachment_declaration** | [**\Phobetor\Allegro\Model\NewAttachmentDeclaration**](../Model/NewAttachmentDeclaration.md)|  | |

### Return type

[**\Phobetor\Allegro\Model\MessageAttachmentId**](../Model/MessageAttachmentId.md)
...
```php
newMessageInThreadPOST($thread_id, $new_message_in_thread): \Phobetor\Allegro\Model\Message
```
...
$new_message_in_thread = new \Phobetor\Allegro\Model\NewMessageInThread(); // \Phobetor\Allegro\Model\NewMessageInThread
...
| **new_message_in_thread** | [**\Phobetor\Allegro\Model\NewMessageInThread**](../Model/NewMessageInThread.md)|  | |
...
```php
newMessagePOST($new_message): \Phobetor\Allegro\Model\Message
```
...
$new_message = new \Phobetor\Allegro\Model\NewMessage(); // \Phobetor\Allegro\Model\NewMessage | Object representing new message.
...
| Name | Type | Description  | Notes |
| ------------- | ------------- | ------------- | ------------- |
| **new_message** | [**\Phobetor\Allegro\Model\NewMessage**](../Model/NewMessage.md)| Object representing new message. | |
...
```php
uploadAttachmentPUT($attachment_id, $body): \Phobetor\Allegro\Model\MessageAttachmentId
```
