# Phobetor\Allegro\PublicOfferInformationApi
...
```php
getListing($category_id, $phrase, $seller_id, $seller_login, $marketplace_id, $shipping_country, $currency, $accept_language, $search_mode, $offset, $limit, $sort, $include, $fallback, $dynamic_filters): \Phobetor\Allegro\Model\ListingResponse
```
