...
```php
classifiedOffersStatsGET($offer_id, $date_gte, $date_lte): \Phobetor\Allegro\Model\OfferStatsResponseDto
```
...
[**\Phobetor\Allegro\Model\OfferStatsResponseDto**](../Model/OfferStatsResponseDto.md)
...
```php
classifiedSellerOfferStatsGET($date_gte, $date_lte): \Phobetor\Allegro\Model\SellerOfferStatsResponseDto
```
...
[**\Phobetor\Allegro\Model\SellerOfferStatsResponseDto**](../Model/SellerOfferStatsResponseDto.md)
